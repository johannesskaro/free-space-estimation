...
OFFSET_LAT = - 0.5e-04   # 1.2091700000382843e-05 # - 0.45e-04
...
H_POINTS_LIDAR_FROM_FLOOR = np.linalg.inv(H_POINTS_FLOOR_FROM_LIDAR)
...
#H_POINTS_RIGHT_ZED_FROM_FLOOR = H @ H_POINTS_LIDAR_FROM_FLOOR
...
H_POINTS_RIGHT_ZED_FROM_FLOOR = H_POINTS_RIGHT_FROM_LEFT_ZED @ H_POINTS_LEFT_ZED_FROM_LEFT_CAM @ H_POINTS_LEFT_CAM_FROM_FLOOR
#H_POINTS_RIGHT_ZED_FROM_FLOOR = H_POINTS_RIGHT_FROM_LEFT_ZED @ H_POINTS_LEFT_ZED_FROM_LEFT_CAM @ H_POINTS_CAM_FROM_FLOOR

H_RIGHT_ZED_FROM_FLOOR = np.linalg.inv(H_POINTS_RIGHT_ZED_FROM_FLOOR)